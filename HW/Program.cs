...
int[] FillArray(int size,int rRange,int lRange)
{
rRange=Console.Readline($"Введите rRange");
lRange=Console.Readline($"Введите lRange");
size=Console.Readline($"Введите size");
int[] arr = new int[size];
for (int i = 0; i < arr.Lenght; i++)
{
    arr[i] = new Random().Next(lRange,rRange);
}
return arr;
}

int[] Array = FillArray(55,5,25);